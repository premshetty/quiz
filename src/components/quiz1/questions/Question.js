...
function Question1() {
  ...
  return (
    <div className="w-full bg-green-300 px-8 h-[100vh] flex flex-col gap-20 ">
      ...
      <button className="px-5 absolute float-right bottom-20 left-20 py-2  h-10 bg-green-800 text-white font-bold rounded-lg border-[1px] border-white">
        Questions Completed {questionNumber - 1}
      </button>
      <button className="px-5 absolute float-right bottom-20 right-20 py-2 w-[140px] h-10 bg-green-800 text-white font-bold rounded-lg border-[1px] border-white">
        SUBMIT
      </button>
    </div>
  );
